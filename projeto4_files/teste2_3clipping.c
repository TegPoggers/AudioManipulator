/*============================================================================*/
/* Exemplo: Aumenta (bastante) o volume do sinal e conta satura��es. Faz hard
 * clipping com 2 n�veis diferentes. */
...
#define OUTPUT_FILE1 "../data/teste2_3_clipping1a.wav"
#define OUTPUT_FILE2 "../data/teste2_3_clipping2a.wav"
